	...
	<section class="animate-effect" style="margin-top:50px; margin-bottom: 50px;">
		...
		<div class="container">
			...
			if($etapa == 0){
				...
				<div class="row">
					<div class="col-sm-12">
						<h2 class="titulo_padrao" ><i class="fa fa-user-circle" aria-hidden="true"></i> CADASTRE-SE</span></h2>
						...
						<form id="cadastro_form" name="cadastro_form" >
							<div class="cadastro_div" > 
								...
								<div class="div_form" >
									...
									<input type="text" class="form-control cadastro_form" name="confirma_email" autocomplete="off" placeholder="Confirme seu E-mail"  >
								</div>
			...
			if($etapa == 1){
				...
				<div class="row">
					<div class="col-sm-12">
						<h2 class="titulo_padrao" ><i class="fa fa-arrow-right" aria-hidden="true"></i> CONTINUE COM SEUS DADOS</span></h2>
						<div class="titulo_padrao_linha" ></div>
					</div>
				</div>
			...
			if($etapa == 2){
				...
				<div class="row">
					<div class="col-sm-12">
						<h2 class="titulo_padrao" ><i class="fa fa-arrow-right" aria-hidden="true"></i> INFORME SEU CEP</span></h2>
						<div class="titulo_padrao_linha" ></div>
					</div>
				</div>
							...
							<div class="cadastro_div" > 
								...
								<div class="div_form" >
									<div style="text-align:left;">
										<div><a href="http://www.buscacep.correios.com.br/sistemas/buscacep/default.cfm" target="_blank" style="font-size:13px; color:#000000" ><i class="fa fa-caret-right" aria-hidden="true"></i> NÃO SEI MEU CEP</a></div>
									</div>
								</div>
			...
			if($etapa == 3){
				...
				<div class="row">
					<div class="col-sm-12">
						<h2 class="titulo_padrao" ><i class="fa fa-lock" aria-hidden="true"></i> CRIE SUA SENHA</span></h2>
						<div class="titulo_padrao_linha" ></div>
					</div>
				</div>
						...
						<form id="cadastro_form" name="cadastro_form" >
							<div class="cadastro_div" >
								...
								<div class="div_form" >
									...
									<input type="password" class="form-control cadastro_form" name="senha" autocomplete="off" placeholder="Digite sua Senha"  >
								</div>
								...
								<div><a href="#" target="_blank" style="font-size:13px; color:#29174A" ><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> ATENÇÃO: NÃO FORNEÇA SUA SENHA A TERCEIROS.</a></div>
									</div>
