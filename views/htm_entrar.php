...
<body>
	...
	<section class="animate-effect" style="margin-top:50px; margin-bottom: 50px;">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h2 class="titulo_padrao" ><i class="fa fa-user-circle" aria-hidden="true"></i> FAÇA <span>SEU LOGIN</span></h2>
					<div class="titulo_padrao_linha" style="padding-bottom:5px;font-weight: 600" >
				</div>
			</div>
				...
				<div class='col-xs-12 col-sm-6 col-md-4'>
					<form id="formlogin" name="formlogin" >
						<div class="login_div" >
							...
							<div style="font-size:15px; text-align:left;color: #000000; font-weight: 600;" ><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> JÁ SOU CLIENTE</div>
							...
							<div class="div_form" >
								<div style="float:left; text-align:left;">
									<div><a href="<?=DOMINIO?><?=$controller?>/recuperar_senha" style="font-size:13px; color: <?=$pagina_cores[6]?>" ><i class="fa fa-key" aria-hidden="true"></i> ESQUECI MINHA SENHA!</a></div>
									<div><a href="<?=DOMINIO?><?=$controller?>/cadastro_basico" style="font-size:13px; color: <?=$pagina_cores[6]?>" ><i class="fa fa-user-plus" aria-hidden="true"></i> CADASTRE-SE</a></div>
									<div id="erro_login"></div>
								</div>
								<button type="button" class="btn btn-fefault cart botao_padrao" onClick="login();" >ENTRAR</button>
							</div>
