						...
						<div class="product-details">
									...
									<div id="similar-product" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner" id="gallery" >
											...
											if($i == 0){
												...
												<img src='".LAYOUT."img/transp.png' style='width:100%; height:100%; border-radius:100px' >
												</div>
												</div>
												";
								...
								<div class="col-xs-12 col-sm-6 col-md-7">
									<div class="product-information" style="border:none; padding-top: 0px;" >                 
										...
										<form name="add_carrinho" id="add_carrinho" action="<?=DOMINIO?><?=$controller?>/carrinho_adicionar" method="post" enctype="multipart/form-data" >
											...
											<?php if($data->ref){ ?>
												<div class="produto_detalhes" ><strong> MODELO:</strong> <?=$data->ref?></div>
											<?php } ?>
											...
											<?php if($data->acabamento){ ?>
												<div class="produto_detalhes" ><strong> Acabamento:</strong> <?=$data->acabamento?></div>
											<?php } ?>

											<?php if($data->producao){ ?>
												<div class="produto_detalhes" ><strong> ENVIO:</strong> <?=$data->producao?></div>
											<?php } ?>
											...
											if(!$esconder_valor){
												...
												if($data->sobconsulta == 1){
													...
													<div class="produto_detalhes_valor" >
														...
														<div class="produtos_detalhes_valortotal" style="text-decoration: line-through;">De: R$ <?=$valor_de?></div>
													...
													<div style="margin-top:20px;">
														<div class="produto_detalhes" ><strong> ENTREGA:</strong> 
							...
							<div class="row">
								...
								<div class="col-sm-12">
									...
									<h4 style="padding-top:20px;" >🔥 DESCRIÇÃO DO <span>SCRIPT</span></h4> 

									<div style="margin-top: 20px;"><?=$data->descricao?></div>
