		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<h2 class="titulo_padrao" >Meus Dados</h2>
					...
					<div class='col-xs-12 col-sm-6 col-md-6'>                   
						...
						<div class="cadastro_div" >
							...
							<div class="div_form" style="text-align:left; margin-top:20px;" >
								<input type="radio" name="tipo" id="tipo_f" value="F" onChange="tipo_cadastro(this.value)" <?php if($data_dados->tipo == 'F'){ echo "checked"; } ?> > <label for="tipo_f">Pessoa Física</label>&nbsp; &nbsp;
								<input type="radio" name="tipo" id="tipo_j" value="J" onChange="tipo_cadastro(this.value)" <?php if($data_dados->tipo == 'J'){ echo "checked"; } ?> > <label for="tipo_j">Pessoa Jurídica</label>
							</div>

							<div id="fisica" <?php if($data_dados->tipo == 'F'){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } ?> >
								...
								<div class="div_form" style="text-align:left; margin-top:5px;" >
									<input type="radio" name="fisica_sexo" id="sexo_m" value="M" <?php if($data_dados->fisica_sexo == 'M'){ echo "checked"; } ?> > <label for="sexo_m" style="font-weight:normal;" > Masculino</label> &nbsp; &nbsp;
									<input type="radio" name="fisica_sexo" id="sexo_f" value="F" <?php if($data_dados->fisica_sexo == 'F'){ echo "checked"; } ?> > <label for="sexo_f" style="font-weight:normal;"> Feminino</label>
								</div>
							...
							<div id="juridica" <?php if($data_dados->tipo == 'J'){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } ?> >
