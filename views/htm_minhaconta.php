		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9 col-md-9">
					<div class="nome_cliente">Olá, <?=$nome_do_usuario?> <a href="<?=DOMINIO?><?=$controller?>/logout" class="botao_padrao <?=$botao_css?>"><i class="fa fa-times" aria-hidden="true"></i> SAIR</a></div>
				</div>

				<div class="col-xs-12 col-sm-3 col-md-3">
					<div class="bt_alterar_dados">
						<button type="button" class="botao_padrao style="width: 270px;" onClick="window.location='<?=DOMINIO?><?=$controller?>/alterar_cadastro';" ><i class="fa fa-user" aria-hidden="true"></i> EDITAR MEUS DADOS</button>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12" >
					...
					<div class="pedidostabela" style="min-height: 300px;">
						...
						<div style="font-size:13px; font-weight:600; color:#666;">🚩 ATENÇÃO: Fique atento no status do seu pedido o envio dos produtos são enviados de forma automática em até 5 Minutos após confirmação do pagamento. você receberá um e-mail informando que o download está disponivel.</div>
