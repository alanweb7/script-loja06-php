...
<div id="section-caracteristicas-<?=$conteudo_id?>" class="container-fluid animate-effect" style="padding-top:10px; padding-bottom:50px; background-color: <?=$cores[22]?>; ">
	...
	<?php if($conteudo_config->descricao){ ?>
		...
		<div class='row' >
			<div class='col-xs-12 col-sm-12 col-md-12' >
				<div style="margin-top:10px; padding-bottom:-20px; font-size: 16px; color:<?=$cores[23]?>; text-align: center;">
	...
	foreach ($caracteristicas_lista as $key => $value) {
		...
		if($conteudo_config->ordem_itens == 1){
			...
			echo "
			<div class='caracteristicas_titulo' style='margin-top:15px;' >".$value['titulo']."</div>
			<div class='caracteristicas_descricao' style='margin-top:10px;' >".$value['descricao']."</div>
			";
		}
